...
private:
	...
	VkPipeline graphicsPipeline; ///////////////////////////////////////// FINALY
	...
	void createInstance() {
		...
		if (success != VK_SUCCESS) {
			throw std::runtime_error("failed to create instance! Error: " + success);
		}
	}
	...
	void loadModel() {
		...
		std::cout << "Finished loading model" << warn << err << std::endl;
	}
	...
	void updateUniformBuffer(uint32_t currentImage) {
		...
		ubo.proj = glm::perspective(glm::radians(45.f), swapChainExtent.width / (float)swapChainExtent.height, .1f, 10.f);
		ubo.proj[1][1] *= -1;
